...
public class Reporting {
	...
	public void generateHTMLreport(String pathToReports) throws IOException, WriteException {
		...
		// полный путь к этому файлу выглядет так: pathToReports + "testReport" + yyyymmddhhss
		String fullPathToFile = pathToReports+ "";  // от сюда https://docs.oracle.com/javase/tutorial/datetime/iso/datetime.html
